...
<div class="single-services">
    <div class="container">
        <div class="row" id="tabs">
            <div class="col-md-4">
                <ul>
                    <li><a href='#tabs-1'>Macbook  <i class="fa fa-angle-right"></i></a></li>
                    <li><a href='#tabs-2'>Apple - Macbook Accessories<i class="fa fa-angle-right"></i></a></li>
                    <li><a href='#tabs-3'>Macbook Repair<i class="fa fa-angle-right"></i></a></li>
                </ul>
            </div>
            <div class="col-md-8">
                <section class='tabs-content'>
                    ...
                    <article id='tabs-2'>
                        ...
                        <h4>Apple - Macbook Accessories</h4>
